...
if __name__=='__main__':
    ...
    parser.add_argument("--s_groups",type=int,default=1)
    ...
    parser.add_argument("--lr_choice",type=str,default="14")
    parser.add_argument("--d0",type=int,default=512)
    parser.add_argument("--d1",type=int,default=64)
    parser.add_argument("--d2",type=int,default=64)
    ...
    parser.add_argument("--num_filters_1",type=int,default=32)
    parser.add_argument("--num_filters_2",type=int,default=32)
    parser.add_argument("--num_filters_3",type=int,default=32)
